...
echo ""
echo "Next steps:"
echo "  1. Get a trial license:"
echo "     https://github.com/CertForge-LLC/certforge-releases"
echo "     (license.jwt is emailed to you — place it in /var/lib/certforge/)"
echo "  2. Also place license_pub.pem from the platform admin into /var/lib/certforge/"
echo "  3. Edit ${CONFIG_FILE} if needed"
echo "  4. Run: certforge"
